      ...
      <ConstrainedBox classNames="px-4 py-8 pt-16 z-20 items-center justify-center">
        <Column classNames="w-full items-center justify-center">
          <div className="flex flex-wrap items-center gap-2">
            <p className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-center text-[var(--textColor)] dark:text-[var(--textColor)]">
              Hi there, I am
            </p>
            <FlipWords
              words={["Ade Muhammad Nur Fauzi.", "@ademnfauzi."]}
              className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-center text-[var(--primaryColor)] dark:text-[var(--primaryColor)]"
            />
          </div>
          ...
          <p className="italic text-sm/normal md:text-base/normal dark:text-[var(--textColorLight)] text-[var(--textColorLight)]">
            "Ensuring Quality, Powering Reliability"
          </p>
