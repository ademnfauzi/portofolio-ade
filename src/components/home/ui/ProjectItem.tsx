...
const ProjectItem = ({ project }: { project: IProjectItem }) => {
  return (
    <CardBox classNames="min-w-[calc(100%-2rem)] sm:min-w-[25rem] md:min-w-[28rem] h-auto min-h-[30rem] p-4 gap-8 items-center justify-between rounded-[var(--borderRadius)] border border-[rgba(255,255,255,0.10)] dark:bg-[var(--primaryColor5)] bg-[var(--primaryColor5)] shadow-[2px_4px_16px_0px_rgba(100,100,100,0.06)_inset] group slide_in">
      ...
      <Column classNames="w-full items-center">
        {project.screenshots && (
          <div className="relative w-full aspect-video mt-4 mb-4 rounded-[var(--borderRadius)] overflow-hidden shadow-md">
            <Image
